...
#else
/* pycom port: was `#include "byteswap.h"` upstream. Quoted form resolved
 * to libwifi's own header (infinite include). Switch to angled form so
 * the system / port shim wins. */
#include <byteswap.h>
